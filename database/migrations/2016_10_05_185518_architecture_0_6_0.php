...
class Architecture060 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('related_languages', function (Blueprint $table) {
            ...
            $table->integer('intelligibility')->unsigned()->nullable();
        });
    ...
    public function down()
    {
        ...
        $drop = [
            'definition_tag', 'definition_language', 'country_language', 'country_culture',
            'alphabet_language', 'data_user',

            'countries', 'transliterations', 'referenceable', 'references', 'media', 'data', 'tags',
